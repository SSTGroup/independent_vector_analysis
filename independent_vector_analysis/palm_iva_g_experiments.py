...
algo_titan = TitanIvaG((0,0.5,0),name='titan',C0=0.2,crit_ext=1e-10,crit_int=1e-10)
algo_titan2 = TitanIvaG((0,0.5,0),name='titan',crit_ext=1e-10,crit_int=1e-10)
...
exp2.compute()
# exp2.get_data_from_folder('2024-02-13_20-06')
# exp2.make_table()
