...
def test_mggd():
    X = MGGD_generation(1000, 7, 0.5, 1, 'uniform')
    X = MGGD_generation(1000, 7, 0.5, 1, 'ar')
    rho = {'val': np.array([0.5, 0.8]), 'idx': np.array([0, 2, 3, 4])}
    X = MGGD_generation(1000, 7, rho, 1, 'two_rho')
    X = MGGD_generation(1000, 7, 0.5, 1, 'q_qt')
    X = MGGD_generation(1000, 7, np.array([0.8, 0.7, 0.7, 0.8, 0.7, 0.8]), 1, 'rho_list')
    X = MGGD_generation(1000, 7, [0.8, 0.7, 0.7, 0.8, 0.7, 0.8], 1, 'rho_list')
